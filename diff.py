...
class Server:
    ...
    def add_connection(self, other):
        ...
        self.server_shadows.append(self.server_text)
...
class Client:
    ...
    def synchronization_step(self):
        if self.client_text != self.client_shadow:      # there's nothing to do if there's no change
            ...
            self.other.server_shadows[self.idx] = self.other.patcher.patch_apply(patches, self.other.server_shadows[self.idx])[0]
